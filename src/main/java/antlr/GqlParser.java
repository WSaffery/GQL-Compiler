...
public class GqlParser extends Parser {
	...
	public static final int
		...
		RULE_fullEdgeUndirected = 18, RULE_fullEdgePointingRight = 19, RULE_elementPatternFiller = 20, 
		RULE_elementPatternPredicate = 21, RULE_propertyList = 22, RULE_returnList = 23, 
		RULE_returnItem = 24, RULE_setOperator = 25, RULE_unionOperator = 26, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"fullEdgePointingRight", "elementPatternFiller", "elementPatternPredicate", 
	...
	public final ElementPatternPredicateContext elementPatternPredicate() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_elementPatternPredicate);
		try {
			setState(243);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final LabelExpressionContext labelExpression() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_labelExpression);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final LabelTermContext labelTerm() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_labelTerm);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
